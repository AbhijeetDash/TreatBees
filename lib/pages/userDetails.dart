...
class UserDetails extends StatefulWidget {
  ...
  const UserDetails({Key key, this.user, this.sp, this.fromOrderPage, this.selection, this.cafeName, this.cafeCode})
      : super(key: key);
  @override
                              ...
                              onPressed: () {
                                if (_formKey.currentState.validate()) {
                                  ...
                                  FirebaseCallbacks()
                                      ...
                                      .then((value) {
                                    if (widget.fromOrderPage) {
                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => Ord(userPhone: controller.text, selection: widget.selection, cafeName: widget.cafeName, user: widget.user, cafeCode: widget.cafeCode,)));
                                    } else {
                                      Navigator.of(context)
                                          .pushReplacement(MaterialPageRoute(
                                          builder: (context) => Home(
